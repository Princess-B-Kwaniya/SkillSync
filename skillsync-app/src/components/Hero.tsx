    ...
    <section className="relative pt-44 pb-24 overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-slate-900 leading-[1.1] mb-8 tracking-tighter">
          ...
          <br />
          <span className="text-primary italic">SkillSync</span> Gets You Hired.
        </h1>

        <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-12 leading-relaxed">
          Bridge the gap between theoretical knowledge and market demand with
          precision upskilling and real-world project simulations.
        </p>
